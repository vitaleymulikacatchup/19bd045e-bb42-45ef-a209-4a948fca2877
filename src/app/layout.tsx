...
export const metadata: Metadata = {
  ...
  description: "Experience luxury hospitality at Luxe Haven Hotel. Book your perfect stay with world-class amenities, fine dining, spa services, and premium rooms.",
  keywords: "luxury hotel, resort, accommodations, premium rooms, fine dining, spa services",
  metadataBase: new URL("https://www.luxehaven.com"),
  alternates: {
    canonical: "https://www.luxehaven.com"
  },
  openGraph: {
    title: "Luxe Haven - Premium Hotel & Resort Accommodations",
    description: "Experience luxury hospitality at Luxe Haven Hotel with premium rooms, world-class amenities, and exceptional service.",
    url: "https://www.luxehaven.com",
    siteName: "Luxe Haven",
    type: "website",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32m5rRdd38TAyU0DZCqvrl288SF/uploaded-1763891019008-hllabvtb.jpg",
  ...
  twitter: {
    ...
    description: "Book your luxury hotel stay with world-class amenities and service",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32m5rRdd38TAyU0DZCqvrl288SF/uploaded-1763891019008-hllabvtb.jpg"]
  },
  robots: {
    index: true,
    follow: true
